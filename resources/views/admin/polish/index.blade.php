...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Polish List</h4>
        </div>
    </div>
</div>
<!-- end page title -->
            ...
            <div class="card-body">
                        ...
                        <!-- <span id="menu-navi"
                            ...
                            <div class="">
                                <a class="btn btn-info waves-effect waves-light"
                                    href="{{ route('admin.polish.create') }}"><i class="fa fa-plus editable" style="font-size:15px;">&nbsp;ADD</i></a>
                            </div>
                        </span> -->
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap w-100 mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('admin.polish.edit', $polish->id) }}"
                                    class="btn btn-outline-primary waves-effect waves-light"><i
                                        class="fa fa-edit"></i></a>
                                <a href="{{ route('admin.polish.destroy', $polish->id) }}"
