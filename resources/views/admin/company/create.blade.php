                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="gst_no" class="form-control" id="gst_no"
                                placeholder="Enter GST No" value="{{ old('gst_no') }}" required>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="address" class="form-control" id="address" placeholder="Enter detail">{{ old('address') }}</textarea>
